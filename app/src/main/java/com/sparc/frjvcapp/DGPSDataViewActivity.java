...
public class DGPSDataViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        syncedView = findViewById(R.id.syncedView);
        ...
        syncedView.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    if (c.getCount() >= 0) {
                        try {
                            ...
                            if (c1.getCount() >= 0) {
                                ...
                                Intent intent = new Intent(getApplicationContext(), DGPSDataViewActivity.class);
                                finish();
