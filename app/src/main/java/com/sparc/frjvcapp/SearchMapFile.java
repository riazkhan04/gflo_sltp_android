...
public class SearchMapFile extends AppCompatActivity {
    ...
    private int checkData() {
        ...
        try {
            ...
            if (mfb.get(0).equals("null") && mfb.get(1).equals("null")) {
                cmvavls = false;
                mmvavls = false;
                status = 2;
            } else {
                ...
                if (!mfb.get(1).equals("null")) {
                    File f = new File(path + "/" + mfb.get(1));
                    if (f.exists()) {
                        mmvsta = true;
                    } else {
                        mmvsta = false;
   ...
   /* private void checkOtherData() {
    ...
    private String GetFilePath() {
        ...
        return folder;//---  /storage/emulated/0/Android/data/com.sparc.frjvcapp/files
    }
