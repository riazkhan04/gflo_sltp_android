...
public class SelectFBForDGPSActivity extends AppCompatActivity {
    ...
    String divValue, rangeValue, fbValue, divid, forbname, fbid, userid, _token, locationRange, rangeCode, vanName, vanValue, foresttype, circle_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circle_id = shared.getString("circle_id", "0");
        //Division.
    ...
    private void getFBDetails(String rangeCode, String divCode) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                fbKey.put(cursor.getString(cursor.getColumnIndex("m_fb_name")) + " " + cursor.getString(cursor.getColumnIndex("fb_type")),
    ...
    private void checkCMVData() {
        try {
            ...
            File f = new File(path + "/" + "jvb_" + circle_id + "_" + divid + "_" + rangeCode + "_" + fbid + ".kml");
            if (f.exists()) {
                cmvsta1 = true;
            } else {
                cmvsta1 = false;
    ...
    private String GetFilePath() {
        ...
        File mapLayerFolder=new File(directory+"/MapLayerDownload");
        if (!mapLayerFolder.exists()){
            mapLayerFolder.mkdirs();
        }
        String folder = mapLayerFolder.getAbsolutePath();
        return folder;
    }
    ...
    private void DownloadCMVMMVFiles() {
        //boolean state, boolean circle, boolean div, boolean ran
        ConnectivityManager cm = (ConnectivityManager) getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo nInfo = cm.getActiveNetworkInfo();
        if (nInfo != null && nInfo.isAvailable() && nInfo.isConnected()) {
            getCMVData("jvb_" + circle_id + "_" + divid + "_" + rangeCode + "_" + fbid + ".kml");
        }
    }
    ...
    public void getCMVData(String filename) {
        try {
            if (!filename.equals("null")) {
                ...
                new DownloadFile().execute(BuildConfig.F_KML_API + "JVBoundry/" + filename);
            } else {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
                alertDialogBuilder.setMessage("JV Boundary for this fb is not available....Please contact your lab coordinator");
                alertDialogBuilder.setPositiveButton("Ok",
                        new DialogInterface.OnClickListener() {
    ...
    private class DownloadFile extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            this.progressDialog = ProgressDialog.show(SelectFBForDGPSActivity.this, "", "Please wait...Your JV Boundary is downloading", false);
        ...
        protected String doInBackground(String... f_url) {
            ...
            if (f_url[0].substring(f_url[0].lastIndexOf('/') + 1) != "null" || f_url[0].substring(f_url[0].lastIndexOf('/') + 1) != "") {
                ...
                return "JV Boundary is missing in the server.Please contact your Admin";
            } else {
